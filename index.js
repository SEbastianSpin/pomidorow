  ...
  countdown() {
    this.intervalid = setInterval(() => {
      ...
      if (this.percent < 0.75 && this.percent >= 0.5) {
        $('html').css({
          "background-image": "linear-gradient(135deg, #88BCC2 0%, #C9DCD6 " + percentB + "%, #F6E1CF 100%)"
        });

      } else if (this.percent < 0.5 && this.percent > 0.25) {
        $('html').css({
          "background-image": "linear-gradient(135deg, #C9DCD6 0%, #F6E1CF " + percentB + "%, #F04F5C 100%)"
        });

      } else if (this.percent <= 0.65 && this.percent >= 0.50) {
        $('html').css({
          "background-image": "linear-gradient(45deg, #F6E1CF 0%, #F04F5C " + percentB + "%, #F27545 100%)"
        });

      } else if (this.percent <= 0.55 && this.percent >= 0.30) {
        $('html').css({
          "background-image": "linear-gradient(45deg, #F04F5C 0%, #F27545 " + percentB + "%, #6B4861 100%)"
        });
